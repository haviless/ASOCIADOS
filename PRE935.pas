...
// HPC_201707_ASO : Referencia en Previsión social HPC_201706_PRE, Se pasa unidad y formulario del modulo de Previsión social (PRE935 y FrmGeneraCtaIndividualPDF)
...
Begin
   ...
   ppltotsalpenpagest.Caption := 'Total aportes pendientes de pago S/ '+FloatToStrF(xmonpen,ffNumber,10,2);
   // Fin: HPC_201706_PRE
   DM1.tTiempoTranscurrido := DM1.tiempoTranscurridoPRE(DM1.FechaSys, StrToDate(DM1.cdsAsociado.FieldByName('ASOFRESNOM').AsString) , '0');
