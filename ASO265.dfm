object fenvarchico: Tfenvarchico
  Left = 214
  Top = 208
  BorderStyle = bsDialog
  Caption = 'Chequeo de registros'
  ClientHeight = 369
  ClientWidth = 905
  Color = 12114134
  ...
  object GroupBox1: TGroupBox
    ...
    object dbdinicio: TwwDBDateTimePicker
      ...
      ShowButton = True
      TabOrder = 0
      OnChange = dbdinicioChange
      OnExit = dbdinicioExit
    end
  ...
  object dbggenenvio: TwwDBGrid
    ...
    TitleLines = 2
    TitleButtons = False
    OnDblClick = dbggenenvioDblClick
  end
