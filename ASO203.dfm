object fActualizarResultado: TfActualizarResultado
  Left = 461
  Top = 213
  Width = 690
  Height = 487
  ActiveControl = dblConocimiento
  Caption = 'Actualizar Resultado'
  Color = 13165023
  ...
  object Panel1: TPanel
    ...
    object dtgResultado: TwwDBGrid
      ...
      TitleLines = 1
      TitleButtons = False
      OnDblClick = dtgResultadoDblClick
  ...
  object GroupBox2: TGroupBox
    ...
    object btnMantAso: TButton
      Left = 372
      Top = 17
      Width = 104
      Height = 25
      Caption = 'Mant. de Asociado'
      TabOrder = 2
      OnClick = btnMantAsoClick
    end
  end
  ...
  object ppbdReporteResultado: TppBDEPipeline
    UserName = 'BDEPReporte'
    Left = 592
    Top = 368
  end
  object pprReporteResultado: TppReport
    AutoStop = False
    DataPipeline = ppbdReporteResultado
    ...
    Template.DatabaseSettings.DataPipeline = ppbdReporteResultado
    Template.FileName = 'C:\Users\rsanchezc.DERRAMA\Desktop\rptResultado.rtm'
    DeviceType = 'Screen'
    ...
    Version = '7.02'
    mmColumnWidth = 0
    DataPipelineName = 'ppbdReporteResultado'
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppltitulo: TppLabel
        UserName = 'ltitulo'
        Caption = 'REPORTE DE RESULTADOS  DE CONSOLIDADO'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
      ...
      object pplNombreAso: TppLabel
        UserName = 'lNombreAso'
        Caption = 'ZEGARRA CHAVEZ SEGUNDO SAUL'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Courier New'
        Font.Size = 10
